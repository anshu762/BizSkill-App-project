  ...
  return (
    <SafeAreaView className="flex-1 bg-surface">
        ...
        <View className="mb-6 items-center rounded-[28px] bg-brand p-8">
          ...
          <View className="mt-6 w-full rounded-2xl bg-indigo-500/30 p-4">
            <Text className="text-center text-sm leading-5 text-indigo-100">
              Complete exchanges to earn {user?.name?.split(" ")[0]}! Each completed swap gives both parties +10 BizCoins.
            </Text>
          </View>
        </View>
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text className="mt-4 text-sm text-muted">No transactions yet. Complete an exchange to earn!</Text>}
        renderItem={({ item }) => {
