...
export default function PostScreen() {
  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "padding"} keyboardVerticalOffset={Platform.OS === "ios" ? 0 : 20} style={{ flex: 1 }}>
        ...
        <View className="flex-1">
          ...
          >
            ...
            <TextInput
              ...
              className="ml-3 flex-1 text-base text-ink bg-white h-12 rounded-xl px-3"
              value={newComment}
